...
public class ModCardProvider implements DataProvider {
	...
	private void addCards() {
		...
		add(new Builder(EntityType.CREEPER, 1, 3, 2).setCardAbility(
				new ModifyAbility(EnumSet.of(CardAbilityTrigger.DEATH), Optional.of(mod("origin_explosion")),
		...
		add(new Builder(EntityType.ZOMBIE, 4, 4, 4).addProperty(CardProperty.UNDEAD, 1)
				.setCardAbility(new ModifyAbility(EnumSet.of(CardAbilityTrigger.SUMMON), Optional.empty(),
		...
		add(new Builder(EntityType.STRAY, 2, 2, 2).addProperty(CardProperty.UNDEAD, 1)
				.setCardAbility(new ModifyAbility(EnumSet.of(CardAbilityTrigger.ATTACK), Optional.empty(),
		...
		add(new Builder(EntityType.ENDERMAN, 6, 4, 5).setCardAbility(
				new CopyCardsAbility(EnumSet.of(CardAbilityTrigger.SUMMON), false, false, false, Optional.empty(),
		...
		add(new Builder(EntityType.GLOW_SQUID, 3, 2, 2).setCardAbility(new ModifyAbility(
				EnumSet.of(CardAbilityTrigger.SUMMON), Optional.of(new ResourceLocation(Main.MODID, "glow")),
		...
		add(new Builder(EntityType.WITHER, 12, 10, 10).addProperty(CardProperty.UNDEAD, 1).setDropChance(1)
				.setDeckCount(1)
				.setCardAbility(new ModifyAbility(EnumSet.of(CardAbilityTrigger.TICK),
						Optional.of(mod("wither_projectile")),
		...
		add(new Builder(EntityType.SQUID, 1, 1, 1).setCardAbility(
				new CopyCardsAbility(EnumSet.of(CardAbilityTrigger.HURT), true, true, false, Optional.empty(),
						new CardAbilitySelection(new CardAbilityGroups(EnumSet.of(CardAbilityGroup.SELF)),
								CardSelectionMethod.ALL, CardCondition.NoCondition.NO_CONDITION))));
		add(new Builder(EntityType.SILVERFISH, 1, 1, 1).setCardAbility(
				new CopyCardsAbility(EnumSet.of(CardAbilityTrigger.HURT), true, false, false, Optional.empty(),
		...
		add(new Builder(EntityType.EVOKER, 5, 2, 2).setCardAbility(
				new ModifyAbility(EnumSet.of(CardAbilityTrigger.SUMMON), Optional.of(mod("evoker_fangs")),
						new CardAbilitySelection(new CardAbilityGroups(EnumSet.of(CardAbilityGroup.ENEMY_BOARD)),
								CardSelectionMethod.ALL, CardCondition.NoCondition.NO_CONDITION),
		...
		add(new Builder(EntityType.ENDER_DRAGON, 10, 13, 5).setDeckCount(1).setDropChance(1)
				.setCardAbility(new MultiAbility(List.of(
						...
						new SummonCardAbility(EnumSet.of(CardAbilityTrigger.SUMMON), CardPlacement.RIGHT,
								new LazyCardType(mod("end_crystal"))),
						new ModifyAbility(EnumSet.of(CardAbilityTrigger.TICK), Optional.of(mod("ender_dragon")),
								new CardAbilitySelection(
		...
		add(new Builder(EntityType.RABBIT, 1, 2, 1).setCardAbility(new ChanceAbility(30,
				new ModifyAbility(EnumSet.of(CardAbilityTrigger.SUMMON), Optional.empty(),
						new CardAbilitySelection(new CardAbilityGroups(EnumSet.of(CardAbilityGroup.SELF)),
								CardSelectionMethod.ALL, CardCondition.NoCondition.NO_CONDITION),
		...
		add(new Builder(EntityType.POLAR_BEAR, 3, 4, 2).addProperty(CardProperty.BABY, 1)
				.setCardAbility(new ModifyAbility(EnumSet.of(CardAbilityTrigger.GROW), Optional.empty(),
						new CardAbilitySelection(new CardAbilityGroups(EnumSet.of(CardAbilityGroup.SELF)),
								CardSelectionMethod.ALL, CardCondition.NoCondition.NO_CONDITION),
		...
		add(new Builder(EntityType.AXOLOTL, 2, 4, 1)
				.setCardAbility(new ModifyAbility(EnumSet.of(CardAbilityTrigger.HURT), Optional.empty(),
						new CardAbilitySelection(new CardAbilityGroups(EnumSet.of(CardAbilityGroup.SELF)),
								CardSelectionMethod.ALL, CardCondition.NoCondition.NO_CONDITION),
		...
		add(new Builder(EntityType.PIG, 2, 2, 3)
				.setCardAbility(new ModifyAbility(EnumSet.of(CardAbilityTrigger.DEATH), Optional.of(mod("throw_pork")),
						new CardAbilitySelection(new CardAbilityGroups(EnumSet.of(CardAbilityGroup.YOUR_BOARD)),
								CardSelectionMethod.ALL, new CardCondition.Entity(EntityType.PLAYER)),
						List.of(new ModificationBuilder().heal(3).build()))));
		...
		add(new Builder(EntityType.GHAST, 7, 3, 7)
				.setCardAbility(new ModifyAbility(EnumSet.of(CardAbilityTrigger.SUMMON), Optional.of(mod("fireball")),
						new CardAbilitySelection(new CardAbilityGroups(EnumSet.of(CardAbilityGroup.ENEMY_BOARD)),
								CardSelectionMethod.ALL, new CardCondition.Entity(EntityType.PLAYER)),
		...
		add(new Builder(EntityType.PANDA, 5, 4, 3).setCardAbility(new SummonCardAbility(
				EnumSet.of(CardAbilityTrigger.SUMMON), CardPlacement.RIGHT,
				new LazyCardType(new Builder(EntityType.ITEM, 0, 5, 0)
						.setAdditionalData(new AdditionalCardData.ItemData(Items.BAMBOO))
						.addProperty(CardProperty.BABY, 1)
						.setCardAbility(new ModifyAbility(EnumSet.of(CardAbilityTrigger.GROW),
								Optional.of(mod("throw_bamboo")),
								new CardAbilitySelection(
										new CardAbilityGroups(
		...
		add(new Builder(EntityType.ELDER_GUARDIAN, 8, 9, 3).addProperty(CardProperty.THORNS, 3)
				.setCardAbility(new ModifyAbility(EnumSet.of(CardAbilityTrigger.SUMMON),
						Optional.of(mod("elder_guardian")),
						new CardAbilitySelection(new CardAbilityGroups(EnumSet.of(CardAbilityGroup.ENEMY_BOARD)),
								CardSelectionMethod.ALL, CardCondition.NoCondition.NO_CONDITION),
						List.of(new ModificationBuilder().addDamage(-1).build()))));
		add(new Builder(EntityType.GOAT, 5, 4, 4).setCardAbility(new CopyCardsAbility(
				EnumSet.of(CardAbilityTrigger.SUMMON), true, false, true, Optional.of(mod("goat_charge")),
				new CardAbilitySelection(new CardAbilityGroups(EnumSet.of(CardAbilityGroup.ENEMY_BOARD)),
						CardSelectionMethod.RANDOM,
						new CardCondition.Not(new CardCondition.Entity(EntityType.PLAYER))))));
		add(new Builder(EntityType.ENDERMITE, 3, 1, 2).setCardAbility(
				new CopyCardsAbility(EnumSet.of(CardAbilityTrigger.SUMMON), true, false, false, Optional.empty(),
						new CardAbilitySelection(new CardAbilityGroups(EnumSet.of(CardAbilityGroup.YOUR_DECK)),
		...
		add(new Builder(EntityType.PILLAGER, 4, 2, 2).setCardAbility(
				new ModifyAbility(EnumSet.of(CardAbilityTrigger.SUMMON), Optional.of(mod("throw_shield")),
						new CardAbilitySelection(new CardAbilityGroups(EnumSet.of(CardAbilityGroup.ADJACENT)),
								CardSelectionMethod.ALL, CardCondition.NoCondition.NO_CONDITION),
						List.of(new ModificationBuilder().addMaxHealth(1).addDamage(1)
								.setProperty(CardProperty.TAUNT, 1).build()))));
		add(new Builder(EntityType.RAVAGER, 9, 10, 4).setCardAbility(
				new ModifyAbility(EnumSet.of(CardAbilityTrigger.ATTACK), Optional.of(mod("ravager_charge")),
		...
		add(new Builder(EntityType.SKELETON, 4, 4, 1).addProperty(CardProperty.UNDEAD, 1)
				.setCardAbility(new ModifyAbility(EnumSet.of(CardAbilityTrigger.TICK), Optional.of(mod("shoot_arrow")),
						new CardAbilitySelection(new CardAbilityGroups(EnumSet.of(CardAbilityGroup.ENEMY_BOARD)),
								CardSelectionMethod.RANDOM, CardCondition.NoCondition.NO_CONDITION),
						List.of(new ModificationBuilder().heal(-1).build()))));
		add(new Builder(EntityType.SPIDER, 2, 2, 2)
				.setCardAbility(new ModifyAbility(EnumSet.of(CardAbilityTrigger.DEATH), Optional.of(mod("throw_web")),
						new CardAbilitySelection(new CardAbilityGroups(EnumSet.of(CardAbilityGroup.ENEMY_HAND)),
								CardSelectionMethod.RANDOM, CardCondition.NoCondition.NO_CONDITION),
		...
		add(new Builder(EntityType.SKELETON_HORSE, 4, 4, 4).addProperty(CardProperty.UNDEAD, 1)
				.setCardAbility(new ModifyAbility(EnumSet.of(CardAbilityTrigger.SUMMON),
						Optional.of(mod("lightning_bolt")),
						new CardAbilitySelection(new CardAbilityGroups(EnumSet.of(CardAbilityGroup.ENEMY_BOARD)),
								CardSelectionMethod.RANDOM, CardCondition.NoCondition.NO_CONDITION),
		...
		add(new Builder(EntityType.SALMON, 1, 1, 1).setCardAbility(new ChanceAbility(50,
				new AddCardsAbility(EnumSet.of(CardAbilityTrigger.DEATH),
						List.of(new LazyCardType(new Builder(EntityType.ITEM, 0, 0, 0)
								...
								.build()))))));
		add(new Builder(EntityType.OCELOT, 3, 3, 3).setCardAbility(new CopyCardsAbility(
				EnumSet.of(CardAbilityTrigger.SUMMON), true, false, true, Optional.empty(),
				new CardAbilitySelection(new CardAbilityGroups(EnumSet.of(CardAbilityGroup.ENEMY_BOARD)),
		...
		add(new Builder(EntityType.SNOW_GOLEM, 4, 4, 4).setCardAbility(
				new ModifyAbility(EnumSet.of(CardAbilityTrigger.SUMMON), Optional.of(mod("throw_snowball")),
						new CardAbilitySelection(new CardAbilityGroups(EnumSet.of(CardAbilityGroup.ENEMY_BOARD)),
		...
		add(new Builder(EntityType.TURTLE, 5, 8, 1).addProperty(CardProperty.BABY, 1)
				.setCardAbility(new AddCardsAbility(EnumSet.of(CardAbilityTrigger.GROW),
						List.of(new LazyCardType(new Builder(EntityType.ITEM, 0, 0, 0)
								.setAdditionalData(new AdditionalCardData.ItemData(Items.SCUTE))
								.setCardAbility(new ModifyAbility(EnumSet.of(CardAbilityTrigger.SUMMON),
										Optional.of(mod("throw_scute")),
										new CardAbilitySelection(
		...
		add(new Builder(EntityType.LLAMA, 1, 1, 1).setCardAbility(new ModifyAbility(
				EnumSet.of(CardAbilityTrigger.SUMMON), Optional.of(mod("llama_spit")),
				new CardAbilitySelection(
						new CardAbilityGroups(EnumSet.of(CardAbilityGroup.YOUR_BOARD, CardAbilityGroup.ENEMY_BOARD)),
						CardSelectionMethod.CHOICE, CardCondition.NoCondition.NO_CONDITION),
				List.of(new ModificationBuilder().heal(-1).build()))));
		...
		add(new Builder(EntityType.TRADER_LLAMA, 5, 4, 4)
				.setCardAbility(
						new ChoiceCardAbility(List.of(
								new ModifyAbility(EnumSet.of(CardAbilityTrigger.SUMMON), Optional.of(mod("llama_spit")),
										new CardAbilitySelection(
												new CardAbilityGroups(EnumSet.of(CardAbilityGroup.YOUR_BOARD,
		...
		add(new Builder(EntityType.ZOMBIE_VILLAGER, 6, 4, 4).addProperty(CardProperty.UNDEAD, 1).setCardAbility(
				new ModifyAbility(EnumSet.of(CardAbilityTrigger.SUMMON), Optional.empty(), new CardAbilitySelection(
		...
		add(new Builder(EntityType.ITEM, 0, 5, 0).setKey(mod("end_crystal"))
				...
				.setCardAbility(new ModifyAbility(EnumSet.of(CardAbilityTrigger.TICK), Optional.empty(),
						new CardAbilitySelection(new CardAbilityGroups(EnumSet.of(CardAbilityGroup.ADJACENT)),
		...
		add(new Builder(EntityType.ITEM, 0, 0, 0).setKey(mod("rotten_flesh"))
				.setAdditionalData(new AdditionalCardData.ItemData(Items.ROTTEN_FLESH)).setCardAbility(
						new ModifyAbility(EnumSet.of(CardAbilityTrigger.SUMMON), Optional.of(mod("throw_rotten_flesh")),
								new CardAbilitySelection(
										new CardAbilityGroups(
												EnumSet.of(CardAbilityGroup.ENEMY_BOARD, CardAbilityGroup.YOUR_BOARD)),
										CardSelectionMethod.CHOICE, CardCondition.NoCondition.NO_CONDITION),
		...
		add(new Builder(EntityType.ITEM, 0, 0, 0).setKey(mod("rabbit_foot"))
				.setAdditionalData(new AdditionalCardData.ItemData(Items.RABBIT_FOOT)).setCardAbility(
						new ModifyAbility(EnumSet.of(CardAbilityTrigger.SUMMON), Optional.of(mod("throw_rabbit_foot")),
								new CardAbilitySelection(
										new CardAbilityGroups(
												EnumSet.of(CardAbilityGroup.ENEMY_BOARD, CardAbilityGroup.YOUR_BOARD)),
										CardSelectionMethod.CHOICE, CardCondition.NoCondition.NO_CONDITION),
		...
		add(new Builder(EntityType.ITEM, 0, 0, 0).setKey(mod("absorption_potion"))
				...
				.setCardAbility(new ModifyAbility(EnumSet.of(CardAbilityTrigger.SUMMON),
						Optional.of(mod("throw_absorption_potion")),
						new CardAbilitySelection(
								new CardAbilityGroups(
										EnumSet.of(CardAbilityGroup.ENEMY_BOARD, CardAbilityGroup.YOUR_BOARD)),
								CardSelectionMethod.CHOICE, CardCondition.NoCondition.NO_CONDITION),
		...
		add(new Builder(EntityType.ITEM, 0, 0, 0).setKey(mod("poison_potion"))
				...
				.setCardAbility(new ModifyAbility(EnumSet.of(CardAbilityTrigger.SUMMON),
						Optional.of(mod("throw_poison_potion")),
						new CardAbilitySelection(
								new CardAbilityGroups(
										EnumSet.of(CardAbilityGroup.ENEMY_BOARD, CardAbilityGroup.YOUR_BOARD)),
								CardSelectionMethod.CHOICE, CardCondition.NoCondition.NO_CONDITION),
		...
		add(new Builder(EntityType.ITEM, 0, 0, 0).setKey(mod("healing_potion"))
				...
				.setCardAbility(new ModifyAbility(EnumSet.of(CardAbilityTrigger.SUMMON),
						Optional.of(mod("throw_healing_potion")),
						new CardAbilitySelection(
								new CardAbilityGroups(
										EnumSet.of(CardAbilityGroup.ENEMY_BOARD, CardAbilityGroup.YOUR_BOARD)),
								CardSelectionMethod.CHOICE, CardCondition.NoCondition.NO_CONDITION),
		...
		add(new Builder(EntityType.ITEM, 0, 0, 0).setKey(mod("packed_ice"))
				.setAdditionalData(new AdditionalCardData.ItemData(Items.PACKED_ICE)).setCardAbility(
						new ModifyAbility(EnumSet.of(CardAbilityTrigger.SUMMON), Optional.of(mod("throw_packed_ice")),
								new CardAbilitySelection(
										new CardAbilityGroups(
												EnumSet.of(CardAbilityGroup.ENEMY_BOARD, CardAbilityGroup.YOUR_BOARD)),
										CardSelectionMethod.CHOICE, CardCondition.NoCondition.NO_CONDITION),
		...
		add(new Builder(EntityType.ITEM, 0, 0, 0).setKey(mod("iron_sword"))
				.setAdditionalData(new AdditionalCardData.ItemData(Items.IRON_SWORD)).setCardAbility(
						new ModifyAbility(EnumSet.of(CardAbilityTrigger.SUMMON), Optional.of(mod("throw_iron_sword")),
								new CardAbilitySelection(
										new CardAbilityGroups(
												EnumSet.of(CardAbilityGroup.ENEMY_BOARD, CardAbilityGroup.YOUR_BOARD)),
										CardSelectionMethod.CHOICE, CardCondition.NoCondition.NO_CONDITION),
		...
		add(new Builder(EntityType.ITEM, 0, 0, 0).setKey(mod("leather_chestplate"))
				.setAdditionalData(new AdditionalCardData.ItemData(Items.LEATHER_CHESTPLATE))
				.setCardAbility(new ModifyAbility(EnumSet.of(CardAbilityTrigger.SUMMON),
						Optional.of(mod("throw_leather_chestplate")),
						new CardAbilitySelection(
								new CardAbilityGroups(
										EnumSet.of(CardAbilityGroup.ENEMY_BOARD, CardAbilityGroup.YOUR_BOARD)),
								CardSelectionMethod.CHOICE, CardCondition.NoCondition.NO_CONDITION),
		...
		add(new Builder(EntityType.ITEM, 0, 0, 0).setKey(mod("iron_boots"))
				.setAdditionalData(new AdditionalCardData.ItemData(Items.IRON_BOOTS)).setCardAbility(
						new ModifyAbility(EnumSet.of(CardAbilityTrigger.SUMMON), Optional.of(mod("throw_iron_boots")),
								new CardAbilitySelection(
										new CardAbilityGroups(
												EnumSet.of(CardAbilityGroup.ENEMY_BOARD, CardAbilityGroup.YOUR_BOARD)),
										CardSelectionMethod.CHOICE, CardCondition.NoCondition.NO_CONDITION),
		...
		add(new Builder(EntityType.ITEM, 0, 0, 0).setKey(mod("ender_pearl"))
				...
				.setCardAbility(new CopyCardsAbility(EnumSet.of(CardAbilityTrigger.SUMMON), true, true, false,
